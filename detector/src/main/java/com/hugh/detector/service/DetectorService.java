...
public class DetectorService {
	...
	public List<DetectorVo> getDetectedListMonthly(String month) {
		System.out.println("[DetectorService] getDetectedListMonthly() called.");
		
		return detectorDao.getDetectedListMonthly(month);
	}

	public List<DetectorVo> getDetectedListDaily(String day) {
		System.out.println("[DetectorService] getDetectedListDaily() called.");
		
		return detectorDao.getDetectedListDaily(day);
	}
